...
public class flightPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(chooseBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void chooseBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_chooseBtnMouseClicked
        // TODO add your handling code here:
        if(this.jPanel1.getBorder() == null && this.chooseBtn.isEnabled()){
            userFlight.chooseTicket(this.id);   
            this.jPanel1.setBorder(new LineBorder(Color.black, 3, true));
        }
        else {
            userFlight.chooseTicket(-1);
